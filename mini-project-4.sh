...
mv s30.wav scp
./sinegen 16000 16 triangle 0 100 0.1 s31.wav
mv s31.wav scp
./sinegen 16000 16 triangle 31.25 2000 0.1 s32.wav
mv s32.wav scp
./sinegen 16000 16 triangle 500 1000 0.1 s33.wav
mv s33.wav scp 
./sinegen 16000 16 triangle 2000 500 0.1 s34.wav
mv s34.wav scp
./sinegen 16000 16 triangle 4000 250 0.1 s35.wav
mv s35.wav scp
./sinegen 16000 16 triangle 44 100 0.1 s36.wav
mv s36.wav scp
./sinegen 16000 16 triangle 220 2000 0.1 s37.wav
mv s37.wav scp
./sinegen 16000 16 triangle 440 1000 0.1 s38.wav
mv s38.wav scp
./sinegen 16000 16 triangle 1760 500 0.1 s39.wav
mv s39.wav scp
./sinegen 16000 16 triangle 3960 250 0.1 s40.wav
mv s40.wav scp
...
mv aeueo-8kHz.set4.txt tmp 

# setting1 s-16k
./spectrogram 0.032 rectangular 0.032 0.01 s-16k.wav s-16k.set1.txt
python3 spectshow.py s-16k.set1.txt s-16k.wav s-16k.set1.pdf
mv s-16k.set1.txt tmp
# setting2 s-16k
./spectrogram 0.032 hamming 0.032 0.01 s-16k.wav s-16k.set2.txt
python3 spectshow.py s-16k.set2.txt s-16k.wav s-16k.set2.pdf
mv s-16k.set2.txt tmp
# setting3  s-16k
./spectrogram 0.03 rectangular 0.032 0.01 s-16k.wav s-16k.set3.txt
python3 spectshow.py s-16k.set3.txt s-16k.wav s-16k.set3.pdf
mv s-16k.set3.txt tmp
# setting4 s-16k
./spectrogram 0.03 hamming 0.032 0.01 s-16k.wav s-16k.set4.txt
python3 spectshow.py s-16k.set4.txt s-16k.wav s-16k.set4.pdf
mv s-16k.set4.txt tmp
# setting1 s-16k
./spectrogram 0.032 rectangular 0.032 0.01 s-8k.wav s-8k.set1.txt
python3 spectshow.py s-8k.set1.txt s-8k.wav s-8k.set1.pdf
mv s-8k.set1.txt tmp 
# setting2 s-8k
./spectrogram 0.032 hamming 0.032 0.01 s-8k.wav s-8k.set2.txt
python3 spectshow.py s-8k.set2.txt s-8k.wav s-8k.set2.pdf
mv s-8k.set2.txt tmp 
# setting3 s-8k
./spectrogram 0.03 rectangular 0.032 0.01 s-8k.wav s-8k.set3.txt
python3 spectshow.py s-8k.set3.txt s-8k.wav s-8k.set3.pdf
mv s-8k.set3.txt tmp 
# setting4 s-8k
./spectrogram 0.03 hamming 0.032 0.01 s-8k.wav s-8k.set4.txt
python3 spectshow.py s-8k.set4.txt s-8k.wav s-8k.set4.pdf
mv s-8k.set4.txt tmp 


rm -r tmp

#using 40+40 times to have shell script
#create by liu-chia-wei